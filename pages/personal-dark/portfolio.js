...
function Portfolio() {
  ...
  return (
    <section
      id="portfolio"
      className="bg-skin-base px-8 py-28 lg:px-32 lg:py-20 text-skin-base"
    >
      ...
      <Modal
        ariaHideApp={false}
        closeTimeoutMS={300}
        className="absolute inset-8 md:inset-20 p-6 lg:p-10 bg-skin-gray outline-none rounded-md"
