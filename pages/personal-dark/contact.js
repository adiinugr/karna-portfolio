          ...
          <div className="text-skin-base flex">
            {socialMediaData.map((socialMedia) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-skin-button-bg-base text-skin-base p-2 mr-2 rounded-md cursor-pointer hover:bg-skin-button-bg-inverted hover:text-skin-button-inverted transition ease-in-out duration-300"
              >
                {socialMedia.icon}
              </a>
            ))}
